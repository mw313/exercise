                    ...
                    foreach(Quiz::$questions as $question) { ?>
                        ...
                        <?php foreach($question['options'] as $answer){ ?>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="answer_option_<?=$question['id'] ?>" value="<?=$answer['id'] ?>">
                                <label class="form-check-label" for="answer_option_<?=$question['id'] ?>"><?=$answer['answer'] ?></label>
                            </div>                            
                        <?php } ?>
                        <script>
                            $("input[name='answer_option_<?=$question['id'] ?>'][value='<?=$question['answer_option'] ?>']").prop("checked",true);
                        </script>
                        <br/>
                <?php } ?>
