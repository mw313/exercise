            ...
            <div class="card-body">
                ...
                <?php foreach($question['answers'] as $answer){ ?>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" id="answer_option<?=$answer['id'] ?>" name="answer_option" value="<?=$answer['id'] ?>">
                        <label class="form-check-label" for="answer_option<?=$answer['id'] ?>"><?=$answer['answer'] ?></label>
                    </div>
                <?php } ?>
            </div>
