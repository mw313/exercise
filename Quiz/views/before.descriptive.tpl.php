    ...
    <div class="col-md-12" style="position: relative">
        <div class = "card">
            ...
            <div class="card-body">
                ...
                با سلام <br/>
                به اطلاع می رساند که مهلت پاسخگویی هر سوال تشریحی <?=(DESCRIPTIVE_TIME/60) ?> دقیقه می باشد. <br/>
                با پایان یافتن مهلت پاسخگویی هر سوال، پاسخ شما به صورت خودکار ذخیره می گردد. <br/>
                در انتها جهت ویرایش پاسخ ها <?=(EDIT_TIME_DESCRIPTIVE/60) ?> دقیقه فرصت وجود دارد. <br/>
